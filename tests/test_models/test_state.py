...
class TestState_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        self.assertIn("[State] (3340976)", state_str)
        self.assertIn("'id': '3340976'", state_str)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        S = State(id="556699", created_at=my_date_iso, updated_at=my_date_iso)
        self.assertEqual(S.id, "556699")
        self.assertEqual(S.created_at, my_date)
        self.assertEqual(S.updated_at, my_date)
